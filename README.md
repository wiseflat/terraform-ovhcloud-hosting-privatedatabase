...
Waiting for this [PR](https://github.com/ovh/terraform-provider-ovh/pull/247) to be merged
...
- A billing account (or your admin account). This account as rights to order privateSQL instances.
- A technical account. This one will be able to manage your privateSQL and will not be able to terminate your service.

## Start from scratch with Terraform

- order a web cloud privateSQL instance
    - mariadb
    - mysql
    - postgresql
    - redis
...
In case your instance was ordered manually from the OVHCloud control panel, a datasource will allow you to manage your privateSQL the same way you ordered it "as code".

## Manage your privateSQL as code

Some terraform resources will allow you to: 

- create many databases
- create users
- manage grants
- whitelist IP address to access to your instance (sftp or service port)

# Let's play with mariadb

## Initialize your workspace

- Set OVHCloud APIv6 variables in your environnement
...
- Add a specific `variables.tfvars` file to add your custom configurations.
